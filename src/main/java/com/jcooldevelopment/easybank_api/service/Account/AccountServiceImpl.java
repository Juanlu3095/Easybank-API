...
public class AccountServiceImpl implements AccountService{
    ...
    @Override
    public PaginatedResponse<AccountDto> getAll(int page, int size) {
    ...
    public AccountDto create(CreateAccountDto createAccountDto) {
        ...
        String bic = env.getProperty("BANK.ENTITY") + branch.getCountry().getCode() + branch.getLocalizationCode() + branch.getBicCode();
    ...
    @Override
    public AccountDto createByAdmin(CreateAccountAdminDto createAccountAdminDto) {
    ...
    public AccountDto update(UUID id, UpdateAccountDto updateAccountDto) {
        return null;
        // Client cannot modify account
    }

    @Override
    public AccountDto updateByAdmin(UUID id, UpdateAccountAdminDto updateAccountAdminDto) {
        Account account = this.accountRepository.findById(id)
            .orElseThrow(() -> new ResourceNotFoundException("Account not found."));
        ...
        return this.accountMapper.EntityToDto(accountToSave);
    }
